...
def get_number_of_games_played(num_teams):
    """
        Ask number of game played from user
    """
    while True:
        games_played = int(
...
def get_team_wins(team_names, games_played):
    """
        Ask number of wins for each team from user
    """
    team_wins = []
...
def get_game_parings(team_wins):
    """
        Paring team
    """
    print("Generating the games to be played in the first round of the tournament...")
    sorted_teams = sorted(team_wins, key=lambda x: x[1])
    game_pairings = []
    ...
    return game_pairings


def print_game_pairing(game_pairings):
    """
        Print first round pairs of the tournament
    """
...
if __name__ == "__main__":
    ...
    # process information and print output
    game_pairings = get_game_parings(team_wins)
    print_game_pairing(game_pairings)
